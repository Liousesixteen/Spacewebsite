    ...
    <div className="min-h-screen bg-space-900 pt-20 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold text-star-white mb-4">
            关于我们
          </h1>
        ...
        <Card className="mb-12">
          <CardContent className="pt-8">
            <h2 className="text-2xl font-bold text-star-white mb-4">我们的使命</h2>
        ...
        <Card className="mb-12">
          <CardContent className="pt-8">
            <h2 className="text-2xl font-bold text-star-white mb-6">我们涵盖的内容</h2>
        ...
        <Card className="mb-12">
          <CardContent className="pt-8">
            <h2 className="text-2xl font-bold text-star-white mb-4">数据来源</h2>
        ...
        <Card>
          <CardContent className="pt-8">
            <h2 className="text-2xl font-bold text-star-white mb-4">开源项目</h2>
            <p className="text-star-dim leading-relaxed mb-6">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-cosmic-blue hover:bg-cosmic-blue/80 text-star-white rounded-lg transition-colors"
            >
