  ...
  return (
    <div className="min-h-screen bg-space-900 pt-20 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card>
            <CardContent className="pt-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-xl font-bold text-white">邮件联系</h2>
              </div>
              ...
              <a
                ...
                className="inline-block px-4 py-2 bg-cosmic-blue hover:bg-cosmic-blue/80 text-white rounded-lg transition-colors"
              >
        ...
        <Card className="mb-12">
          <CardContent className="pt-8">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-white mb-2">报告问题</h2>
        ...
        <Card>
          <CardContent className="pt-8">
            <h2 className="text-xl font-bold text-white mb-4">响应时间</h2>
            <p className="text-star-dim leading-relaxed">
