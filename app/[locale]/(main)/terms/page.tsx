  ...
  return (
    <div className="min-h-screen bg-space-900 pt-20 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-star-white mb-2">服务条款</h1>
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardContent className="pt-8">
              <h2 className="text-2xl font-bold text-star-white mb-4">服务说明</h2>
              <p className="text-star-dim leading-relaxed">
          ...
          <Card>
            <CardContent className="pt-8">
              <h2 className="text-2xl font-bold text-star-white mb-4">用户行为</h2>
          ...
          <Card>
            <CardContent className="pt-8">
              <h2 className="text-2xl font-bold text-star-white mb-4">知识产权</h2>
              <p className="text-star-dim leading-relaxed">
          ...
          <Card>
            <CardContent className="pt-8">
              <h2 className="text-2xl font-bold text-star-white mb-4">数据准确性免责声明</h2>
              <p className="text-star-dim leading-relaxed">
          ...
          <Card>
            <CardContent className="pt-8">
              <h2 className="text-2xl font-bold text-star-white mb-4">服务变更</h2>
              <p className="text-star-dim leading-relaxed">
          ...
          <Card>
            <CardContent className="pt-8">
              <h2 className="text-2xl font-bold text-star-white mb-4">责任限制</h2>
              <p className="text-star-dim leading-relaxed">
