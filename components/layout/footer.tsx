...
export function Footer({ locale }: FooterProps) {
  ...
  return (
    <footer className="bg-space-900 border-t border-space-700 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <Link href={`/${locale}`} className="flex items-center gap-2 mb-4 group">
              ...
              <span className="text-lg font-bold text-gradient">SpaceData</span>
            </Link>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-star-dim hover:text-cosmic-blue transition-colors"
                aria-label="GitHub"
              >
        ...
        {/* Bottom Section */}
        <div className="border-t border-space-700 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-star-dim">
            {t('footer.copyright')}
          </p>
          <p className="text-sm text-star-dim">
